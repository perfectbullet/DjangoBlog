...
# style.font.color.rgb = RGBColor(255, 10, 20)
...
image = _p1.add_picture('瓦尔基里.jpg', width=Inches(5), height=Inches(3))

title = ['name', 'age', 'sex']

table = doc.add_table(rows=1, cols=3, style='Colorful Grid Accent 6')
