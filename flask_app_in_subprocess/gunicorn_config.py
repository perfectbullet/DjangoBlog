...
daemon = True
backlog = 100                # 监听队列
chdir = '/root/flask_app_in_subprocess'  # gunicorn要切换到的目的工作目录
...
p          process ID
"""
accesslog = "/root/flask_app_in_subprocess/gunicorn_access.log"      #访问日志文件
errorlog = "/root/flask_app_in_subprocess/gunicorn_error.log"        #错误日志文件
