...
class LoginTest(BaseTest):
    def test_login(self):
        ...
        tokenized_data = decode_token(access_token)

        # This raises an AssertionError
        assert tokenized_data.get("sub").get("id") == user.id

        # This raises an AssertionError
        assert tokenized_data.get("sub").get("admin") == 0
    ...
    def test_login_admin(self):
        ...
        # This raises an AssertionError
        assert tokenized_data.get("sub").get("admin") == 1
    ...
    def test_login_super_admin(self):
        ...
        # This raises an AssertionError
        assert tokenized_data.get("sub").get("admin") == 2
