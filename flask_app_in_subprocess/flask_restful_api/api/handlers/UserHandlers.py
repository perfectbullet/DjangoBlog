...
class Register(Resource):
    ...
    def post():
        ...
        return {"status": "registration completed.", "code": CODE200}
...
class Login(Resource):
    ...
    def post():
        ...
        refresh_token = create_access_token(identity={"id": user.id, "email": user.email}, expires_delta=timedelta(minutes=60))
...
class RefreshToken(Resource):
    ...
    def post():
        ...
        return {"access_token": token, "code": CODE200}
...
class ResetPassword(Resource):
    ...
    def post(self):
        ...
        return {"status": "password changed.", "code": CODE200}
