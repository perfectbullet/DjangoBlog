...
File Name: gui.py
Author: sunch， perfect
Create Date: 2022/11/10 10:36
-------------------------------------------------
"""
...
class NewKeyGUI:
    ...
    def init_window(self):
        ...
        # Entry
        self.key_name_entry = Entry(self.frame, width=50, bd=11, textvariable=self.key_name, font=('YaHei', 10))
...
class EncLicGUI:
    ...
    def init_window(self):
        self.frame.title('GX License加密')  # 窗口名
